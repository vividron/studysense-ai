...
const DocumentCard = ({ doc, handleDelete }) => {
    return (
        <Link to={`/documents/${doc._id}`}>
            <div className="relative group rounded-xl bg-(--bg-surface) border border-white/10 p-5 transition hover:bg-(--bg-surface-hover) 
            hover:border-white/20 hover:scale-[0.97] ease-in-out duration-300">
                <div className="space-y-3">
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0 space-y-3">
                            ...
                            <div className="flex items-center gap-3 mt-1">
                                <span className="text-xs text-gray-400">{doc.fileSize}
                                </span>
                    ...
                    <div className="text-xs text-gray-400">Uploaded on {new Date(doc.uploadDate).toLocaleString(undefined, {
